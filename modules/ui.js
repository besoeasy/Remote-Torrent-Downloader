  ...
  <div class="max-w-6xl mx-auto p-6 space-y-8">
    ...
    <header class="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
      <div class="text-center sm:text-left">
        <h1 class="text-3xl font-bold tracking-tight text-black">UniDL</h1>
      ...
      <div class="flex items-center gap-3">
        ...
        <a href="https://github.com/besoeasy/UniDL" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-black hover:bg-zinc-800 text-white text-sm font-medium rounded-full transition-all shadow-sm hover:shadow-md">
